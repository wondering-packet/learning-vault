...
nano login-hotfix  
# usual staging & commiting. note that we will need to commit our hotfixes before we can cherry-pick them anywhere. cherry-picking requires specifying the commit 
git add .  
